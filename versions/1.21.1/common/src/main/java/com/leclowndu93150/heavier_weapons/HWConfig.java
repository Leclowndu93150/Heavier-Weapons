...
public class HWConfig {
    ...
    public static boolean criticalStrikeCompat = true;
    ...
    public static void load() {
        ...
        Path configFile = Path.of("config").resolve("heavier_weapons.properties");
        ...
        if (Files.exists(configFile)) {
            try (InputStream in = Files.newInputStream(configFile)) {
                ...
                criticalStrikeCompat = Boolean.parseBoolean(props.getProperty("criticalStrikeCompat", "true"));
                ...
                HeavierWeapons.LOG.warn("Failed to load config, using defaults", e);
            }
        } else {
            save(configFile);
        }
    ...
    private static void save(Path configFile) {
        try {
            ...
            props.setProperty("criticalStrikeCompat", String.valueOf(criticalStrikeCompat));
            ...
            HeavierWeapons.LOG.warn("Failed to save config", e);
        }
    }
